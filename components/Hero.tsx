...
export default function Hero() {
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-center items-center px-4 pt-28 pb-20 overflow-hidden bg-gradient-to-b from-trust-peach via-trust-peach-warm/50 to-trust-peach">
      ...
      <div className="relative mx-auto max-w-4xl flex flex-col items-center text-center">
        <Image
          ...
          width={160}
          height={160}
          className="rounded-full object-cover ring-4 ring-white shadow-soft-hover mb-8 animate-fade-in opacity-0 [animation-fill-mode:forwards]"
        />
