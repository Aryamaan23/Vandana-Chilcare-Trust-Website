...
export const galleryItems: GalleryItem[] = [
  {
    id: 'new-year-sapru',
    image: '/gallery/tej-sapru-hospital.jpg',
    imagePng: '/gallery/tej-sapru-hospital.jpg',
    imageJpg: '/gallery/tej-sapru-hospital.jpg',
  ...
  },
  {
    ...
    image: '/gallery/tulsi-day-celebrations.jpg',
    imagePng: '/gallery/tulsi-day-celebrations.jpg',
    imageJpg: '/gallery/tulsi-day-celebrations.jpg',
    title: 'Tulsi Day, Christmas & Talent Felicitation',
    date: 'Prayagraj',
    caption: 'Vandana Child Care Trust celebrated Tulsi Day with great enthusiasm along with the children receiving training at its Cultural Centre on Minto Road. Children were informed about the importance of the Tulsi plant and were given a message on environmental conservation. The program was organized under the leadership of President Vandana Pandey, Vice President Kalpana Gupta, and Treasurer Mamta Maharani, with members Dr. Pratibha Mishra, Sudha Srivastava, Bhavna Gaur, and Fatima Ali in attendance. Ved Sharma, a student of the training center, was specially honored for winning a gold medal at the state-level Taekwondo championship. The main arrangements were managed by Neelu Sharma, Head of the Training Center, with active participation from head girls Shalini and Khushi. Embracing "Vasudhaiva Kutumbakam" (the world is one family), the Trust also celebrated Christmas and distributed gifts. The objective was to instill cultural values, mutual love, harmony, and social unity among children, along with encouraging them toward sports and education.',
  },
  {
    id: 'teachers-day',
  ...
  },
  {
    ...
    image: '/gallery/visionless-kids.jpg',
    imagePng: '/gallery/visionless-kids.jpg',
    imageJpg: '/gallery/visionless-kids.jpg',
  ...
  {
    id: 'raj-blind-school',
    image: '/gallery/raj-blind-school.jpg',
    imagePng: '/gallery/raj-blind-school.jpg',
    imageJpg: '/gallery/raj-blind-school.jpg',
