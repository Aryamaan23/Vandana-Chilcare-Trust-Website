...
export const reports: Report[] = [
  ...
  },
  {
    ...
    date: '2024–2025',
    summary: 'Overview of health awareness sessions conducted at Tej Bahadur Sapru Hospital, Belly Hospital, and community settings, with focus on children and women.',
  },
];
...
export const programmes: Programme[] = [
  {
    ...
    images: [G(`Screenshot 2026-02-24 at 8.53.09${N}PM.png`)],
  },
  {
    id: 'tulsi-christmas-talent',
    title: 'Tulsi Day, Christmas & Talent Felicitation',
    date: '2025',
    location: 'Training Centre, Minto Road, Prayagraj',
    category: 'Cultural',
    status: 'completed',
    ...
    images: [G(`Screenshot 2026-02-24 at 8.53.29${N}PM.png`)],
  },
  {
    ...
    images: [G(`Screenshot 2026-02-24 at 8.54.17${N}PM.png`)],
  },
  {
    id: 'teachers-day',
  ...
  },
  {
    ...
    images: [G(`Screenshot 2026-02-24 at 8.54.02${N}PM.png`)],
  },
  {
    id: 'training-centre-operations',
    title: 'Training Centre — Academic & Vocational Guidance',
    date: 'Ongoing',
    location: 'Minto Road, Prayagraj',
    category: 'Education',
    status: 'current',
    description: 'The Vandana Childcare Trust Training Centre provides academic and vocational guidance to children in a supportive environment. Regular classes, mentorship, and skill development programmes are conducted under the leadership of the Trust.',
    images: [
